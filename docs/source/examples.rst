...
`Bootstrapping PCA In The Digits Dataset <https://github.com/atavory/ibex/blob/master/examples/digits_bootstrapping_pca.ipynb>`_

    This is a version o the :mod:`sklearn` example `Pipelining: chaining a PCA and a logistic regression <http://scikit-learn.org/stable/auto_examples/plot_digits_pipe.html#sphx-glr-auto-examples-plot-digits-pipe-py>`_. It illustrates the use of pipelines. 
